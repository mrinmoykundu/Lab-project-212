...
a=getappdata(0,'depth');
if(~isnan(a))
    set(handles.depth_base,'String',num2str(a));
    set(handles.depth_slider, 'value', a);
end

a=getappdata(0,'m');
if(~isnan(a))
    set(handles.m_base,'String',num2str(a/5.69375));
    set(handles.m_slider, 'value', a/5.69375);
end

a=getappdata(0,'r_e');
if(~isnan(a))
    set(handles.r_e_base,'String',num2str(a));
    set(handles.r_e_slider, 'value', a);
end
